...
- Saves timestamped note to `.planning/notes/` (or `D:/1.Product Development with AI/1.1 project/4.Cost of living tracker/Design system with codex/.codex/notes/` globally)
