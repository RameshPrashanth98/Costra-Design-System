...
```bash
INIT=$(node "D:/1.Product Development with AI/1.1 project/4.Cost of living tracker/Design system with codex/.codex/get-shit-done/bin/gsd-tools.cjs" init list-workspaces)
